...
class RscTitles
{
    class vnd_Dialog
    {
        ...
        class controls
        {
            ...
            {
                idc = -1;
                x = UI_EXPR(WX_POS + GRID_W(1));
                y = UI_EXPR(WY_POS + GRID_H(1));
                w = UI_EXPR(GRID_W(22));
                h = UI_EXPR(GRID_H(8));
                ...
                class controls
                {
                    class TL_ModeText: ctrlStructuredText
                    {
                        ...
                        shadow = 2; colorShadow[] = {0,0,0,0.8}; size = UI_EXPR(SZ_M);
                        text = "ACRO";
                        x = 0; y = 0; w = UI_EXPR(GRID_W(22)); h = UI_EXPR(GRID_H(1.5));
                    };
                    class TL_TimeText: ctrlStructuredText
                    {
                        ...
                        shadow = 2; colorShadow[] = {0,0,0,0.8}; size = UI_EXPR(SZ_M);
                        text = "11:16";
                        x = 0; y = UI_EXPR(GRID_H(1.6)); w = UI_EXPR(GRID_W(22)); h = UI_EXPR(GRID_H(1.5));
                    };
                    class TL_AltText: ctrlStructuredText
                    {
                        ...
                        shadow = 2; colorShadow[] = {0,0,0,0.8}; size = UI_EXPR(SZ_M);
                        text = "6.7 alt m";
                        x = 0; y = UI_EXPR(GRID_H(3.2)); w = UI_EXPR(GRID_W(22)); h = UI_EXPR(GRID_H(1.5));
                    };
                };
            };
            ...
            class TC_Group: ctrlControlsGroupNoScrollBars
            {
                ...
                w = UI_EXPR(GRID_W(24));
                h = UI_EXPR(GRID_H(2));
                x = UI_EXPR(WX_POS + (W_WIDTH/2) - GRID_W(24)/2);
                y = UI_EXPR(WY_POS + GRID_H(1));
                ...
                class controls
                {
                    class TC_Voltage1: ctrlStructuredText
                    {
                        ...
                        shadow = 2; colorShadow[] = {0,0,0,0.8}; size = UI_EXPR(SZ_M);
                        text = "21.3V";
                        x = 0; y = 0; w = UI_EXPR(GRID_W(11)); h = UI_EXPR(GRID_H(2));
                    };
                    class TC_Voltage2: ctrlStructuredText
                    {
                        ...
                        shadow = 2; colorShadow[] = {0,0,0,0.8}; size = UI_EXPR(SZ_M);
                        text = "3.55V";
                        x = UI_EXPR(GRID_W(13)); y = 0; w = UI_EXPR(GRID_W(11)); h = UI_EXPR(GRID_H(2));
                    };
                };
            };
            ...
            class BL_Group: ctrlControlsGroupNoScrollBars
            {
                idc = -1;
                x = UI_EXPR(WX_POS + GRID_W(1));
                y = UI_EXPR(WY_POS + W_HEIGHT - GRID_H(8) - GRID_H(1));
                w = UI_EXPR(GRID_W(24));
                h = UI_EXPR(GRID_H(8));
                ...
                class controls
                {
                    class BL_LinkText: ctrlStructuredText
                    {
                        ...
                        class Attributes { font = "VCROSDMono"; align = "left"; shadow = 2; color = "#FFFFFFFF"; shadowColor = "#000000CC"; };
                        shadow = 2; colorShadow[] = {0,0,0,0.8}; size = UI_EXPR(SZ_S);
                        text = "link-ok";
                        x = 0; y = 0; w = UI_EXPR(GRID_W(24)); h = UI_EXPR(GRID_H(1.3));
                    };
                    class BL_RxText: ctrlStructuredText
                    {
                        ...
                        shadow = 2; colorShadow[] = {0,0,0,0.8}; size = UI_EXPR(SZ_S);
                        text = "rx: -2.232";
                        x = 0; y = UI_EXPR(GRID_H(1.4)); w = UI_EXPR(GRID_W(24)); h = UI_EXPR(GRID_H(1.3));
                    };
                    class BL_TxText: ctrlStructuredText
                    {
                        ...
                        shadow = 2; colorShadow[] = {0,0,0,0.8}; size = UI_EXPR(SZ_S);
                        text = "tx: 0.961";
                        x = 0; y = UI_EXPR(GRID_H(2.8)); w = UI_EXPR(GRID_W(24)); h = UI_EXPR(GRID_H(1.3));
                    };
                    class BL_FWText: ctrlStructuredText
                    {
                        ...
                        shadow = 2; colorShadow[] = {0,0,0,0.8}; size = UI_EXPR(SZ_S);
                        text = "FW: 2.17";
                        x = 0; y = UI_EXPR(GRID_H(4.2)); w = UI_EXPR(GRID_W(24)); h = UI_EXPR(GRID_H(1.3));
                    };
                };
            };
            ...
            class BC_FPS_Text: ctrlStructuredText
            {
                ...
                shadow = 2; colorShadow[] = {0,0,0,0.8}; size = UI_EXPR(SZ_S);
                text = "FPS: 31";
                w = UI_EXPR(GRID_W(12)); h = UI_EXPR(GRID_H(1.5));
                x = UI_EXPR(0.5 - GRID_W(12)/2);
                y = UI_EXPR(WY_POS + W_HEIGHT - GRID_H(3));
            };
            ...
            class RB_Group: ctrlControlsGroupNoScrollBars
            {
                ...
                w = UI_EXPR(GRID_W(26));
                h = UI_EXPR(GRID_H(12));
                x = UI_EXPR(WX_POS + (W_WIDTH/2) + GRID_W(2));
                y = UI_EXPR(WY_POS + W_HEIGHT - GRID_H(8) - GRID_H(1));
                ...
                class controls
                {
                    class RB_CurrentText: ctrlStructuredText
                    {
                        ...
                        shadow = 2; colorShadow[] = {0,0,0,0.8}; size = UI_EXPR(SZ_S);
                        text = "40.6 A";
                        x = 0; y = 0; w = UI_EXPR(GRID_W(26)); h = UI_EXPR(GRID_H(1.3));
                    };
                    class RB_mAhText: ctrlStructuredText
                    {
                        ...
                        shadow = 2; colorShadow[] = {0,0,0,0.8}; size = UI_EXPR(SZ_S);
                        text = "7721 mAh";
                        x = 0; y = UI_EXPR(GRID_H(1.4)); w = UI_EXPR(GRID_W(26)); h = UI_EXPR(GRID_H(1.3));
                    };
                    class RB_PercentText: ctrlStructuredText
                    {
                        ...
                        shadow = 2; colorShadow[] = {0,0,0,0.8}; size = UI_EXPR(SZ_S);
                        text = "48 %";
                        x = 0; y = UI_EXPR(GRID_H(2.8)); w = UI_EXPR(GRID_W(26)); h = UI_EXPR(GRID_H(1.3));
                    };
                    class RB_ThrottleText: ctrlStructuredText
                    {
                        ...
                        shadow = 2; colorShadow[] = {0,0,0,0.8}; size = UI_EXPR(SZ_S);
                        text = "spd: 57 %";
                        x = 0; y = UI_EXPR(GRID_H(4.2)); w = UI_EXPR(GRID_W(26)); h = UI_EXPR(GRID_H(1.3));
                    };
                    class RB_PitchText: ctrlStructuredText
                    {
                        ...
                        shadow = 2; colorShadow[] = {0,0,0,0.8}; size = UI_EXPR(SZ_S);
                        text = "pitch: 3.3";
                        x = 0; y = UI_EXPR(GRID_H(5.6)); w = UI_EXPR(GRID_W(26)); h = UI_EXPR(GRID_H(1.3));
                    };
                    class RB_SNText: ctrlStructuredText
                    {
                        ...
                        shadow = 2; colorShadow[] = {0,0,0,0.8}; size = UI_EXPR(SZ_S);
                        text = "SN: 9621391";
                        x = 0; y = UI_EXPR(GRID_H(7.0)); w = UI_EXPR(GRID_W(26)); h = UI_EXPR(GRID_H(1.3));
                    };
                };
            };
            ...
            class H_Line_L: ctrlStaticPicture
            {
                ...
                x = UI_EXPR(0.5 - GRID_W(1) - GRID_W(12));
                y = UI_EXPR(0.5 - GRID_H(0.5)/2 - GRID_H(0.6));
            };
